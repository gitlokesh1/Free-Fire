...
import { ArrowLeft, Upload, AlertTriangle, CheckCircle, XCircle, Clock } from 'lucide-react';
      ...
      return (
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-emerald-700 font-semibold">Result Verified</p>
          </div>
          <p className="text-gray-600 text-sm">Kills: {result.participant.kills}</p>
          <p className="text-gray-600 text-sm">Rank: #{result.participant.rank}</p>
      ...
      return (
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-amber-700 font-semibold">Result Submitted</p>
          </div>
          <p className="text-gray-500 text-sm">Waiting for admin verification...</p>
        </div>
      );
    }
    if (s === 'rejected') {
      return (
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-red-600 font-semibold">Result Rejected</p>
          </div>
          <p className="text-gray-500 text-sm">Contact support for help</p>
        </div>
      );
    }
    return null;
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="font-semibold text-gray-900">Upload Result</h1>
      </div>
      ...
      <div className="px-4 pt-4 max-w-sm mx-auto space-y-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-amber-700 font-semibold text-sm mb-1">Screenshot Requirements</p>
        ...
        {(!result || result.participant.status === 'joined') && (
          <div>
            ...
            <div
              ...
              className="border-2 border-dashed border-gray-300 hover:border-indigo-400 bg-white rounded-xl p-8 text-center cursor-pointer transition-colors"
            >
              {preview ? (
                ...
                <>
                  ...
                  <p className="text-gray-700 font-medium">Upload Screenshot</p>
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-4 rounded-xl w-full mt-4 flex items-center justify-center gap-2 disabled:opacity-50 transition-colors"
            >
              {uploading ? (
